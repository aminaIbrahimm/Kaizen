        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="#"
                className="flex font-bold text-[18px] items-center p-2 text-blue-950 rounded-lg dark:text-white hover:text-blue-800 dark:hover:bg-gray-700 group"
              >
            ...
            <li>
              <button
                ...
                className="flex font-bold text-[18px] items-center w-full p-2 text-base text-blue-950 transition duration-75 rounded-lg group hover:text-blue-800 dark:text-white dark:hover:bg-gray-700 cursor-pointer"
              >
                ...
                {openCareer ? (
                  <FaAngleUp className="text-blue-800" />
                ) : (
              ...
              {openResource && (
                <ul id="dropdown-resource" className="py-2 space-y-2">
                  ...
                  <li>
                    <a
                      href="#"
                      className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 gap-2"
                    >
            ...
            <li>
              <button
                ...
                className="flex items-center w-full p-2 font-bold text-[18px] text-blue-950 transition duration-75 rounded-lg group hover:text-blue-800 dark:text-white dark:hover:bg-gray-700 cursor-pointer"
              >
            ...
            <p className="bg-amber-600 rounded py-3 px-2 text-white text-center my-12 mx-2 flex justify-center items-center gap-3 cursor-pointer">
            ...
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-blue-950 rounded-lg dark:text-white hover:text-blue-800 dark:hover:bg-gray-700 group"
              >
